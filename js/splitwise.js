...
function crearElementoCuenta(usuarios) {
    ...
    // Calcular el total de todos los gastos de todos
    ...
    usuarios.forEach(usuario => {
        ...
        let totalPagadoPorUsuario = usuario.totalPagado();
        let diferencia = totalPagadoPorUsuario - cantidadCadaUno;
        ...
        if (diferencia < 0) {
            ...
            textoTarjeta.textContent = `${usuario.nombre} ha pagado ${totalPagadoPorUsuario}€, ha saldado las deudas.`;
        }
